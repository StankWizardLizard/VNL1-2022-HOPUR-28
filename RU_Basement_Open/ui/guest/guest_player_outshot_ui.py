...
class OutShotTable(MenuFrame):
    ...
    def display_menu(self, division_leaderboard, showing_page):
        ...
        OUTSHOT_PTS = "Outshot Pts" # Header for "Wins" column
        ...
        table_format = [[NUMBER, NR], [PLAYER_NAME, TN], [OUTSHOT_PTS, WS]]
        try:
    ...
    def prompt_option(self, showing_page:int=0):
        ...
        division_leaderboard = self.logic_wrapper.get_player_leaderboard_by_division(self.division.id,"outshot")
