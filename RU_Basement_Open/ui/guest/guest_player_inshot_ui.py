...
class InShotTable(MenuFrame):
    ...
    def display_menu(self, division_leaderboard, showing_page):
        ...
        INSHOT_PTS = "Inshot Pts" # Header for "Wins" column
    ...
    def prompt_option(self, showing_page:int=0):
        ...
        division_leaderboard = self.logic_wrapper.get_player_leaderboard_by_division(self.division.id,"inshot")
